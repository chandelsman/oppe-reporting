...
client_group <- function(`Sequence Group`) {
  case_when(
    ...
    `Sequence Group` == "NGYN (MCR)"          ~ "UCHealth North",
    `Sequence Group` == "NGYN (MHC)"          ~ "UCHealth South",
    `Sequence Group` == "NGYN (MHCC DC)"      ~ "Memorial Hospital of Converse County",
    `Sequence Group` == "NGYN (MHN)"          ~ "UCHealth South",
    ...
    `Sequence Group` == "SURG (CPMC)"         ~ "St Elizabeth Hospital",
    ...
    `Sequence Group` == "SURG (GRANDVIEW)"    ~ "UCHealth South",
    ...
    `Sequence Group` == "SURG (MCR)"          ~ "UCHealth North",
    `Sequence Group` == "SURG (MHC)"          ~ "UCHealth South",
    `Sequence Group` == "SURG (MHCC DC)"      ~ "Memorial Hospital of Converse County",
    `Sequence Group` == "SURG (MHN)"          ~ "UCHealth South",
    ...
    `Sequence Group` == "SURG (PVH)"          ~ "UCHealth North",
