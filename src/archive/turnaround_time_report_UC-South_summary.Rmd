...
<br><br>
<div align="center"> <h3> Statistics by Facility: `r params$cl_grp` </div>


```{r table TAT by facility, message = FALSE, warning = FALSE}
...
ta_time %>% 
  filter(cl_grp == params$cl_grp, PATHOLOGIST != "Long, Daniel") %>%
...
consult_int <- consult_int %>% 
  filter(Correlation != "Select", `Primary Pathologist` != "Long, Daniel") %>% # exclude if blank
  mutate(
    `Sequence Group` = str_replace(`Sequence Group`, "\\*SURG", "SURG"),
    `Sequence Group` = str_replace(`Sequence Group`, "OP SURG", "SURG OP"),
    `Sequence Group` = str_replace(`Sequence Group`, "OP NGYN", "NGYN OP"),
...
<br><br>
<div align="center"> <h3> External Consultations: `r params$cl_grp` </div>


```{r external consultations, message = FALSE, warning = FALSE}
...
<P style="page-break-before: always">
<br>
<div align="center"> <h3> Intraoperative Consultations: `r params$cl_grp` </div>
...
<br><br>
<div align="center"> <h3> Intraoperative Consultations by Pathologist: `r params$cl_grp` </div>


```{r table intraoperative consultations by pathologist, message = FALSE, warning = FALSE}
