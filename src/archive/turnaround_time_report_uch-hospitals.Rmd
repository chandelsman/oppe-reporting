...
ta_time_01 <- readxl::read_excel("./data/q120_01tat.xls",
  col_types =
    c(
      "guess",
      "guess",
...
ta_time_02 <- readxl::read_excel("./data/q120_02tat.xls",
  col_types =
    c(
      "guess",
      "guess",
...
ta_time_03 <- readxl::read_excel("./data/q120_03tat.xls",
  col_types =
    c(
      "guess",
      "guess",
...
# build quarterly data set
ta_time_Q <- dplyr::bind_rows(ta_time_01, ta_time_02, ta_time_03)
...
case_stats %>% bind_rows(group_stats) %>%
  gt(rowname_col = "type") %>%
  tab_header(title = md("*CPT codes 8831 and 8841 **excluded***"),
             subtitle = "") %>%
  fmt_number(columns = vars(Cases),
             decimals = 0,
             use_seps = TRUE) %>%
...
consult_int <- read_excel("./data/int_q1_20.xls")
...
consult_ext <- read_excel("./data/ext_q1_20.xls")
...
consult_iop <- read_excel("./data/iop_q1_20.xls")
