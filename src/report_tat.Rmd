...
# VERIFY FILE NAMES BEFORE RUNNING!

# turn around time data ---------------------------------------------------
ta_time_raw <- readxl::read_excel(
  "./data/2020q3-tat.xlsx",
  col_types =
    c(
      "guess",
      "guess",
...
consult_int <- read_excel("./data/2020q3-int.xls")

# external consultation data ----------------------------------------------
consult_ext <- read_excel("./data/2020q3-ext.xls")

# intraoperative consultation data ----------------------------------------
consult_iop <- read_excel("./data/2020q3-iop.xls")
